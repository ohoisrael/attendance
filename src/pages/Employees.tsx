...
const Employees: React.FC = () => {
  ...
  const [employees] = useState(mockUsers);
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-green-600">
              {employees.filter(emp => emp.activation).length}
            </div>
            ...
            <TableBody>
              {filteredEmployees.map((employee) => (
                <TableRow key={employee.id}>
                  ...
                  <TableCell>
                    <Badge variant={employee.activation ? 'default' : 'secondary'}>
                      {employee.activation ? 'Active' : 'Inactive'}
                    </Badge>
                  </TableCell>
                  <TableCell>
                    <div className="flex space-x-2">
